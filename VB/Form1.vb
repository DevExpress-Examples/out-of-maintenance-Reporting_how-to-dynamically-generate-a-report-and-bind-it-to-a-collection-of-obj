...
Namespace K18078
	Partial Public Class Form1
		...
		Private Function GenerateRecords() As List(Of MyComplexObject)
			Return New List(Of MyComplexObject)() From {
				New MyComplexObject() With {
					.Address = "507 - 20th Ave. E.Apt. 2A",
					.FirstName = "Nancy",
					.LastName = "Davolio",
					.City = "Seattle",
					.Age = 30,
					.FederalId = "11-1123-12345",
					.Salary = 6000
				},
				New MyComplexObject() With {
